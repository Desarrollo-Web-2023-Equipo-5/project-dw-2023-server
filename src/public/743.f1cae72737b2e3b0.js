...
(self.webpackChunkproject_dw_2023_client =
	...
	{
		6743: (Tt, U, s) => {
			s.r(U), s.d(U, { ProtectedModule: () => Zt });
			var d = s(4755),
				p = s(4660),
				Y = s(5577),
				l = s(5580),
			...
			let w = (() => {
				class o {
					constructor(e) {
						(this.http = e),
							(this.baseUrl = y.N.apiUrl || 'http://localhost:3000/api');
					}
					updateImage(e, n, a) {
			...
			let F = (() => {
						...
						(o.ɵcmp = t.Xpm({
							...
							template: function (e, n) {
								1 & e &&
									...
									t._uU(5),
									t.qZA(),
									t.YNc(6, J, 1, 0, 'mat-progress-bar', 4),
									t.qZA(),
							...
							dependencies: [d.O5, u.lW, l.ZT, l.uh, l.xY, l.H8, q.pW],
						})),
						o
					);
				})(),
				h = (() => {
					class o {
						...
						getUserById(e) {
							return this.http
								.get(`${this.baseUrl}/users/${e}`)
								.pipe((0, f.U)(n => n.user));
						}
						updateUser(e, n) {
							return this.http.put(`${this.baseUrl}/users/${e}`, n);
						}
						getCurrentUserCampaigns(e) {
							return this.http
								.get(`${this.baseUrl}/users/${e}/campaigns`)
								.pipe((0, f.U)(n => n.campaigns));
						}
						...
						createComment(e) {
							return this.http
								.post(`${this.baseUrl}/comments`, e)
								.pipe((0, f.U)(n => n.id));
						}
						getComments(e) {
							return this.http
								.get(`${this.baseUrl}/comments${e}`)
								.pipe((0, f.U)(n => n.comments));
						}
						deleteComment(e) {
						...
						createCampaign(e) {
							return this.http
								.post(`${this.baseUrl}/campaigns`, e)
								.pipe((0, f.U)(n => n.id));
						}
						getCampaigns() {
							return this.http
								.get(`${this.baseUrl}/campaigns`)
								.pipe((0, f.U)(e => e.campaigns));
						}
						getNotification() {
						...
						getCampaign(e) {
							return this.http
								.get(`${this.baseUrl}/campaigns/${e}`)
								.pipe((0, f.U)(n => n.campaign));
						}
					}
					return (
						(o.ɵfac = function (e) {
			...
			let S = (() => {
				...
				return (
					(o.ɵfac = function (e) {
						return new (e || o)(t.Y36(l.so), t.Y36(l.WI));
					}),
					(o.ɵcmp = t.Xpm({
						type: o,
						...
						dependencies: [u.lW, l.ZT, l.uh, l.xY, l.H8],
					})),
					o
				);
			})();
			...
			let O = (() => {
				...
				return (
					(o.ɵfac = function (e) {
						return new (e || o)(t.Y36(_.e), t.Y36(h), t.Y36(x._W), t.Y36(l.uw));
					}),
					(o.ɵcmp = t.Xpm({
						type: o,
						...
						dependencies: [d.O5, p.rH, u.nh, v.Hw, m.kc],
			...
			function Q(o, i) {
				if (
					(1 & o &&
						(t.TgZ(0, 'div', 10), t.YNc(1, G, 2, 1, 'div', 11), t.qZA()),
					2 & o)
				) {
					const e = t.oxw(2);
			...
			let N = (() => {
				class o {
					...
					ngOnInit() {
						(this.isLoadingComments = !0),
							this.apiService
								...
								.subscribe({
									next: n => {
										(this.comments = n), (this.isLoadingComments = !1);
									},
									error: n => {
					...
					sendComment() {
						...
						this.apiService.createComment(e).subscribe({
							next: n => {
								(e.id = n), this.comments.push(e), this.commentForm.reset();
							},
							error: n => {
				...
				return (
					(o.ɵfac = function (e) {
						return new (e || o)(t.Y36(c.qu), t.Y36(_.e), t.Y36(h), t.Y36(x._W));
					}),
					(o.ɵcmp = t.Xpm({
						type: o,
						...
						template: function (e, n) {
							if (
								(1 & e &&
									(t.YNc(0, $, 10, 4, 'div', 0),
									t.YNc(1, j, 2, 0, 'ng-template', null, 1, t.W1O)),
								2 & e)
							) {
								const a = t.MAs(2);
			...
			function D(o, i) {
				1 & o && (t.TgZ(0, 'button', 7), t._uU(1, ' INVITE TO GAME '), t.qZA());
			}
			function H(o, i) {
				if (
					(1 & o &&
						(t.TgZ(0, 'mat-card-actions'),
						t.YNc(1, D, 2, 0, 'button', 6),
						t.qZA()),
					2 & o)
				) {
					const e = t.oxw(2);
					t.xp6(1), t.Q6J('ngIf', e.user.isLookingForGroup);
				}
			}
			function X(o, i) {
				if (1 & o) {
			...
			function B(o, i) {
				if (
					(1 & o &&
						(t.TgZ(0, 'mat-card-actions'),
						t.YNc(1, X, 2, 1, 'button', 8),
						t.YNc(2, K, 2, 1, 'button', 9),
						t.qZA()),
					2 & o)
				) {
					const e = t.oxw(2);
			...
			function W(o, i) {
				if ((1 & o && t._UZ(0, 'app-comments-section', 12), 2 & o)) {
					const e = t.oxw(2);
			...
			function V(o, i) {
				if (1 & o) {
					...
					t.TgZ(0, 'div')(1, 'mat-card')(2, 'mat-card-header')(3, 'img', 1),
						...
						t._uU(7),
						t.qZA()(),
						t.YNc(8, H, 2, 1, 'mat-card-actions', 0),
						t.YNc(9, B, 3, 2, 'mat-card-actions', 0),
						t.qZA(),
						t.TgZ(10, 'mat-tab-group', 2)(11, 'mat-tab', 3),
						t.YNc(12, W, 1, 1, 'ng-template', 4),
						t.qZA(),
						t.TgZ(13, 'mat-tab', 5),
						t.YNc(14, z, 1, 0, 'ng-template', 4),
						t.qZA()()();
				}
				if (2 & o) {
					const e = t.oxw();
			...
			let tt = (() => {
				class o {
					...
					ngOnInit() {
						this.activatedRoute.params
							.pipe((0, Y.z)(e => this.apiService.getUserById(e.id)))
							.subscribe({
								next: e => {
									this.user = e;
								},
				...
				return (
					(o.ɵfac = function (e) {
						return new (e || o)(t.Y36(p.gz), t.Y36(h), t.Y36(_.e), t.Y36(l.uw));
					}),
					(o.ɵcmp = t.Xpm({
						type: o,
						...
						consts: [
							...
							['color', 'accent', 'mat-flat-button', '', 4, 'ngIf'],
			...
			function et(o, i) {
				if (
					(1 & o &&
						(t.TgZ(0, 'div')(1, 'mat-card', 1)(2, 'mat-card-content', 2)(
							3,
							'div'
						)(4, 'p'),
						t._uU(5),
						...
						t._uU(8),
						t.qZA(),
						t.TgZ(9, 'button', 4)(10, 'mat-icon'),
						t._uU(11, 'play_circle'),
						t.qZA()()()()()()),
					2 & o)
				) {
					const e = t.oxw();
			...
			let ot = (() => {
				...
				return (
					...
					(o.ɵcmp = t.Xpm({
						...
						template: function (e, n) {
							1 & e && t.YNc(0, et, 12, 4, 'div', 0),
								2 & e && t.Q6J('ngIf', n.post);
						},
						dependencies: [d.O5, p.rH, u.RK, v.Hw, m.a8, m.dn],
						styles: [
					...
					return (
						...
						(o.ɵcmp = t.Xpm({
							...
							template: function (e, n) {
								1 & e &&
									(t.TgZ(0, 'mat-list'),
									t.YNc(1, nt, 2, 1, 'mat-list-item', 0),
									t.qZA()),
									2 & e && (t.xp6(1), t.Q6J('ngForOf', n.filteredPosts));
							},
							dependencies: [d.sg, Z.i$, Z.Tg, ot],
							styles: [
			...
			let st = (() => {
				...
				return (
					(o.ɵfac = function (e) {
						return new (e || o)(t.Y36(_.e), t.Y36(p.F0));
					}),
					(o.ɵcmp = t.Xpm({
						type: o,
						...
						dependencies: [p.rH, L.Ye, at.gM, u.RK, u.cs, v.Hw],
					})),
					o
				);
			})();
				...
				return (
					...
					(o.ɵcmp = t.Xpm({
						...
						consts: [
							...
							['src', '../../../../assets/logo.svg', 'alt', '', 1, 'brand'],
							[
								'mat-icon-button',
								'',
								'routerLink',
						...
						template: function (e, n) {
							if (
								(1 & e &&
									...
									t._UZ(2, 'img', 1),
									t.qZA(),
									t.TgZ(3, 'div')(4, 'button', 2)(5, 'mat-icon', 3),
									t._uU(6, 'notifications'),
									t.qZA()(),
									t.TgZ(7, 'button', 4)(8, 'mat-icon'),
									t._uU(9, 'chat_bubble'),
									t.qZA()(),
									t.TgZ(10, 'button', 5)(11, 'mat-icon'),
									t._uU(12, 'description'),
									t.qZA()(),
									t.TgZ(13, 'button', 6)(14, 'mat-icon'),
									t._uU(15, 'more_vert'),
									t.qZA()(),
									t.TgZ(16, 'mat-menu', null, 7)(18, 'button', 8),
									t.NdJ('click', function () {
										return n.logout();
									}),
									t.TgZ(19, 'mat-icon'),
								...
								const a = t.MAs(17);
								t.xp6(5),
									t.Q6J('matBadge', n.notifications),
									t.xp6(8),
									t.Q6J('matMenuTriggerFor', a);
							}
						},
						dependencies: [p.rH, L.Ye, u.RK, v.Hw, T.VK, T.OP, T.p6, rt.k],
						styles: ['.brand[_ngcontent-%COMP%]{width:4em;height:4em}'],
					})),
					o
				);
			})();
			function ut(o, i) {
				if (1 & o) {
					const e = t.EpF();
					t.TgZ(0, 'mat-list-item')(1, 'div', 1)(2, 'div', 2)(3, 'div', 3)(
						4,
						'h3',
						4
					),
						t._uU(5),
						t.qZA()()(),
						t.TgZ(6, 'div')(7, 'button', 5),
						t.NdJ('click', function () {
							const r = t.CHM(e).$implicit,
								g = t.oxw();
							return t.KtG(g.acceptNotification(r));
						}),
						t.qZA(),
						t.TgZ(8, 'button', 6),
						t.NdJ('click', function () {
							const r = t.CHM(e).$implicit,
								g = t.oxw();
							return t.KtG(g.rejectNotification(r));
						}),
						t.qZA()()()();
				}
				if (2 & o) {
					const e = i.$implicit;
					t.xp6(5), t.Oqu(e.title);
				}
			}
			function gt(o, i) {
				1 & o &&
					(t.TgZ(0, 'div', 4)(1, 'span'),
					t._uU(2, 'You currently have no posts'),
					t.qZA()());
			}
			function ft(o, i) {
				if (
					(1 & o && (t.TgZ(0, 'div'), t._UZ(1, 'app-post-list', 5), t.qZA()),
					2 & o)
				) {
					const e = t.oxw();
					t.xp6(1), t.Q6J('filteredPosts', e.campaignPosts);
				}
			}
			function _t(o, i) {
				if (1 & o) {
			...
			const vt = [
				{
					...
					children: [
						{ path: 'profile/:id', component: tt },
						{ path: 'feed', component: it },
						{
							path: 'create-post',
							component: (() => {
								class o {}
										...
										return (
											this.api
												...
												.subscribe({
													...
													error: g => {
														console.error(g),
															this.toastr.error(g.error.errors[0].msg);
													},
												}),
											this.campaignForm.value
										);
								...
								return (
									...
									(o.ɵcmp = t.Xpm({
										...
										consts: [
											...
											['mat-button', '', 'color', 'warn', 3, 'click'],
										],
										template: function (e, n) {
											1 & e &&
												(t.TgZ(0, 'mat-list'),
												t.YNc(1, ut, 9, 1, 'mat-list-item', 0),
												t.qZA()),
												2 & e && (t.xp6(1), t.Q6J('ngForOf', n.notifications));
										},
										dependencies: [d.sg, u.lW, Z.i$, Z.Tg],
									})),
									o
								);
							})(),
						},
						{
							...
							component: (() => {
								class o {
									...
									constructor(e, n) {
										(this.api = e), (this.auth = n), (this.campaignPosts = []);
									}
									ngOnInit() {
										this.api
											.getCurrentUserCampaigns(this.activeUser.id)
											.subscribe({
												next: e => {
													this.campaignPosts = e;
												},
								...
								return (
									(o.ɵfac = function (e) {
										return new (e || o)(t.Y36(h), t.Y36(_.e));
									}),
									(o.ɵcmp = t.Xpm({
										type: o,
										selectors: [['app-my-posts']],
										decls: 4,
										vars: 2,
										consts: [
											['mat-align-tabs', 'center'],
											['label', 'My Posts'],
											['class', 'text-center mt-5', 4, 'ngIf'],
											[4, 'ngIf'],
											[1, 'text-center', 'mt-5'],
											[3, 'filteredPosts'],
										],
										template: function (e, n) {
											1 & e &&
												(t.TgZ(0, 'mat-tab-group', 0)(1, 'mat-tab', 1),
												t.YNc(2, gt, 3, 0, 'div', 2),
												t.YNc(3, ft, 2, 1, 'div', 3),
												t.qZA()()),
												2 & e &&
													(t.xp6(2),
													t.Q6J('ngIf', 0 === n.campaignPosts.length),
													t.xp6(1),
													t.Q6J('ngIf', n.campaignPosts.length > 0));
										},
										dependencies: [d.O5, C.uX, C.SP, I],
									})),
									o
								);
							})(),
							...
							component: (() => {
								...
								return (
									...
									(o.ɵcmp = t.Xpm({
										...
										styles: ['img[_ngcontent-%COMP%]{max-height:30em}'],
									})),
									o
								);
							})(),
			...
			let bt = (() => {
				...
				return (
					...
					(o.ɵmod = t.oAB({ type: o })),
					(o.ɵinj = t.cJS({ imports: [p.Bz.forChild(vt), p.Bz] })),
					o
				);
			})();
			var xt = s(1603);
			let Zt = (() => {
				...
				return (
					...
					(o.ɵmod = t.oAB({ type: o })),
					(o.ɵinj = t.cJS({ imports: [d.ez, bt, xt.q, c.UX] })),
					o
				);
			})();
		},
