		...
		2867: (m, l, o) => {
			...
			let g = (() => {
				...
				return (
					...
					(n.ɵmod = t.oAB({ type: n })),
					(n.ɵinj = t.cJS({ imports: [r.Bz.forChild(a), r.Bz] })),
					n
				);
			})();
			var d = o(1603);
			let s = (() => {
				...
				return (
					...
					(n.ɵmod = t.oAB({ type: n })),
					(n.ɵinj = t.cJS({ imports: [i.ez, g, d.q] })),
					n
				);
			})();
		},
